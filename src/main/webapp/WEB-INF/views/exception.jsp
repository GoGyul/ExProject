	...
	<div class="container text-center">
		<div class="panel panel-default panel-exception">
			<div class="panel-body text-center">
				...
				<h1 class="pan-title">${status }</h1>
				<p class="pan-content">요청한 페이지를 찾을수 없습니다.</p>
			</div>
		</div>
		<button type="button" class="btn btn-danger btn-lg" onclick="history.back()">뒤로가기</button>
		<button type="button" class="btn btn-danger btn-lg" onclick="location.href='/sam/main.do'">메인으로</button>
		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-sm-9">
						<h1 class="alert-title">${status }</h1>
